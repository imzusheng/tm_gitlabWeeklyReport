...
!(function (e, t) {
    ...
    e.useEffect(() => {
      ;(async () => {
        try {
          const e = await $(),
            t = e ? { ...b, ...e } : b
          a(e => ({ ...e, config: t, theme: t.theme || b.theme }))
        } catch (e) {
          a(e => ({ ...e, config: b, theme: b.theme }))
        }
      })()
    }, [])
  ...
  const U = () => {
    ...
    B = 'index-module__filter-label__kgsrz',
    q = 'index-module__filter-options__83wOv',
    V = 'index-module__filter-option__SG0B9',
    z = 'index-module__active__IQgMz',
    H = [
      { value: 'week', label: '本周' },
      { value: '7d', label: '最近7天' },
      ...
      return m.jsxs('div', {
        ...
        children: [
          m.jsxs('div', {
            className: F,
            children: [
              m.jsx('label', { className: B, children: '时间范围' }),
              m.jsx('div', {
                className: q,
          ...
          n.map(({ key: t, label: n, options: s }) =>
            m.jsxs(
              'div',
              {
                className: F,
                children: [
                  m.jsx('label', { className: B, children: n }),
                  m.jsxs('div', {
                    className: q,
                    children: [
                      m.jsx('button', {
                      ...
                      s.map(({ value: n, label: s }) =>
                        m.jsx(
                          'button',
                          {
                            className: `${V} ${Array.isArray(e[t]) && e[t].includes(n) ? z : ''}`,
                            onClick: () =>
                              ((t, n, s) => {
                                const l = e[t],
      ...
      ({
        ...
        return 0 === n
          ? m.jsx('div', {
              ...
              children: m.jsx('div', {
                className: Y.info,
                children: m.jsx('span', { children: '暂无数据' }),
              }),
            })
          : m.jsxs('div', {
              className: Y.pagination,
              children: [
                ...
                m.jsxs('div', {
                  ...
                  children: [
                    m.jsx('button', {
                      className: `${Y.paginationBtn} ${1 === t ? Y.disabled : ''}`,
                      onClick: () => u(t - 1),
                      disabled: 1 === t,
                      ...
                      m.jsx(
                        e.Fragment,
                        {
                          children:
                            'number' == typeof a
                              ? m.jsx('button', {
                                  className: `${Y.paginationBtn} ${t === a ? Y.active : ''}`,
                                  onClick: () => u(a),
                                  children: a,
                                })
                              : m.jsx('span', {
                                  className: Y.paginationEllipsis,
                                  children: a,
                                }),
                        },
                        n,
                    ...
                    m.jsx('button', {
                      className: `${Y.paginationBtn} ${t === d ? Y.disabled : ''}`,
                      onClick: () => u(t + 1),
                      disabled: t === d,
                      children: m.jsx('span', { children: '›' }),
                    }),
                ...
                l &&
                  m.jsxs('div', {
                    className: Y.paginationSizeChanger,
                    children: [
    ...
    re = 'index-module__event-row__nD7Rz',
    de = 'index-module__selected__QNHpl',
    ce = 'index-module__cell__KsOts',
    _e = 'index-module__event-icon__9UCQ3',
    ue = 'index-module__event-content__YCPED',
    me = 'index-module__event-title__530MV',
    pe = 'index-module__event-description__C3Fjc',
    he = 'index-module__action-tag__GZU05',
    xe = 'index-module__event-time__1VIXa',
    ge = 'index-module__detail-btn__Q5YpF',
    ve = 'index-module__detail-icon__E5Shy',
    ...
    ye = 'index-module__loading-spinner__C04N8',
    ke = 'index-module__checkbox-container__UxYEH',
    Ce = 'index-module__checkmark__-Dj1c',
    we = e.memo(
      ({
        events: t,
        totalCount: a,
        ...
        const u = e.useCallback(
          ...
          h = e.useMemo(
            () => t.length > 0 && t.every(e => r.includes(e.id)),
            [t, r],
          ),
          x = e.useMemo(() => r.length > 0 && !h, [r.length, h]),
          g = e.useCallback(() => {
            c(!h)
          }, [c, h]),
          v = e.useCallback(
              ...
              children: [
                ...
                m.jsxs('div', {
                  ...
                  children: [
                    ...
                    m.jsx('span', { className: ie, children: p('created_at') }),
                  ],
                }),
                m.jsx('div', { className: `${ee} ${le}`, children: '详情' }),
              ],
            }),
            m.jsx('div', {
              className: oe,
              children: n
                ...
                : 0 === t.length
                  ? m.jsxs('div', {
                      className: je,
                      children: [
                        m.jsx('div', { className: be, children: '📄' }),
                  ...
                  : t.map(e => {
                      const t = r.includes(e.id),
                        { icon: a, title: n, actionType: s } = f(e)
                      return m.jsxs(
                        'div',
                        {
                          className: `${re} ${t ? de : ''}`,
                          children: [
                            ...
                            m.jsxs('div', {
                              className: `${ce} ${ae}`,
                              children: [
                                m.jsx('div', { className: _e, children: a }),
                                m.jsxs('div', {
                                  className: ue,
                                  children: [
                                    m.jsx('div', {
  ...
  class Ee {
     ...
     */ async getProjectsWithTotal(e = {}) {
      ...
      if (!l.ok) {
        ...
        throw S.createApiError(l.status, e || l.statusText, 'GitLab API')
      }
  ...
  const Ie = ({
      ...
      const { state: o } = R(),
        ...
        [j, b] = e.useState({ starred: !1, membership: !0 }),
        [f, N] = e.useState(1),
        [y, k] = e.useState(0),
        [C, w] = e.useState(null),
        E = e.useRef(null),
        ...
        $ = e.useCallback(
          ...
          [s, t, j, g, h, f, a, n, o.config.gitlabUrl, o.config.gitlabToken],
        ),
        I = e.useMemo(
          () => e => {
      ...
      e.useEffect(() => {
        const e = e => {
          E.current && !E.current.contains(e.target) && d(!1)
        }
        return (
      ...
      const U = e.useMemo(() => c.find(e => e.id === a), [c, a]),
        G = Math.ceil(y / 20)
      return m.jsxs('div', {
        className: Te.projectSelector,
        ref: E,
        children: [
          m.jsxs('div', {
            className: `${Te.selectorTrigger} ${r ? Te.open : ''} ${l ? Te.disabled : ''}`,
            onClick: () => !l && d(!r),
            children: [
              m.jsx('span', {
                className: Te.selectedText,
                children: U ? U.path_with_namespace : '请选择项目',
              }),
              m.jsx('span', {
                className: `${Te.arrow} ${r ? Te.up : Te.down}`,
                children: '▼',
              }),
            ],
          }),
              ...
              children: [
                m.jsxs('div', {
                  ...
                  children: [
                    ...
                    m.jsxs('div', {
                      className: Te.filtersSection,
                      children: [
                        m.jsxs('div', {
                          className: Te.filterOptions,
                          children: [
                            m.jsxs('label', {
                              className: Te.filterOption,
                              children: [
                                m.jsx('input', {
                                  type: 'checkbox',
                                  checked: j.membership,
                                  onChange: e =>
                                    L('membership', e.target.checked),
                                }),
                                '我的项目',
                              ],
                            }),
                            m.jsxs('label', {
                              ...
                              children: [
                                m.jsx('input', {
                                  type: 'checkbox',
                                  checked: j.starred,
                                  onChange: e => L('starred', e.target.checked),
                                }),
                                '已收藏',
                              ],
                            }),
                        ...
                        m.jsxs('div', {
                          className: Te.sortOptions,
                          children: [
                            m.jsx('label', { children: '排序：' }),
                            m.jsxs('select', {
                              value: g,
                ...
                m.jsx('div', {
                  className: Te.projectList,
                  children: u
                    ? m.jsxs('div', {
                        className: Te.loading,
                        children: [
                          m.jsx('div', { className: Te.spinner }),
                          '加载中...',
                        ],
                      })
                    : C
                      ? m.jsx('div', { className: Te.error, children: C })
                      : 0 === c.length
                        ? m.jsxs('div', {
                            className: Te.emptyState,
                            children: [
                              m.jsx('div', {
                                className: Te.emptyIcon,
                                children: '📄',
                              }),
                              m.jsx('div', {
                                className: Te.emptyText,
                                children: '暂无项目',
                              }),
                              m.jsx('div', {
                                className: Te.emptyHint,
                        ...
                        : c.map(e =>
                            m.jsxs(
                              'div',
                              {
                                className: `${Te.projectItem} ${e.id === a ? Te.selected : ''}`,
                                onClick: () => P(e.id),
                                children: [
                                  m.jsxs('div', {
                                    className: Te.projectInfo,
                                    children: [
                                      m.jsx('div', {
                                        className: Te.projectName,
                                        children: e.name,
                                      }),
                                      m.jsx('div', {
                                        className: Te.projectPath,
                                        children: e.path_with_namespace,
                                      }),
                                      e.description &&
                                        m.jsx('div', {
                                          className: Te.projectDescription,
                ...
                G > 1 &&
                  m.jsxs('div', {
                    className: Te.pagination,
                    children: [
                      m.jsx('button', {
                        className: Te.pageButton,
                        disabled: f <= 1,
                        onClick: () => O(f - 1),
                        children: '上一页',
                      }),
                      m.jsxs('div', {
                        className: Te.pageInfo,
                        children: [
                          m.jsxs('span', { children: [f, ' / ', G] }),
                          m.jsxs('div', {
                            className: Te.totalCount,
                            children: ['共 ', y, ' 个项目'],
                          }),
                        ],
                      }),
    ...
    De = 'index-module__changelogPanel__bsoH5',
    Ae = 'index-module__projectSelectorContainer__DVUJQ',
    Le = 'index-module__eventsListContainer__JlSig',
    Pe = 'gitlab-changelog-selected-project',
    Oe = () => {
      const { state: t, isConfigValid: a } = R(),
        {
          createRequest: n,
          isRequestCancelled: s,
          cleanupRequest: l,
        ...
        o = e.useMemo(
          () => Se(t.config.gitlabUrl, t.config.gitlabToken),
        ...
        [u, p] = e.useState(0),
        [h, x] = e.useState(!1),
        [g, v] = e.useState({ field: 'created_at', order: 'desc' }),
        [j, b] = e.useState({ page: 1, pageSize: 20, total: 0 }),
        [f, N] = e.useState([]),
        y = e.useCallback(e => {
          d(e),
            e
    ...
    Re = 'index-module__action-btn__To7Ms',
    ...
    tt = ({ currentVersion: t }) => {
      ...
      const b = e.useCallback((e, t) => {
        ...
        f = e.useCallback(
          async (e = !0) => {
            if (!s)
              if (x && a && i && e) (!e && v.has(a.version)) || d(!0)
              else {
                l(!0), p(null)
                try {
                  ...
                  n(m), _(new Date()), g(!0)
                  const p = b(t, m.version)
                  o(p), p && ((!e && v.has(m.version)) || d(!0))
                } catch (r) {
          ...
          children: [
            m.jsxs('button', {
              ...
              title: c
                ...
                : '点击检查更新',
              children: [
                m.jsx('span', { className: Be, children: E() }),
                m.jsx('span', { className: qe, children: w() }),
              ],
            }),
            r &&
              i &&
    ...
    at = 'index-module__main-panel__82FLm',
    nt = 'index-module__panel-header__kyx4p',
    st = 'index-module__header-left__xT1T5',
    lt = 'index-module__header-right__7F8Bo',
    it = 'index-module__mode-toggle__9yafG',
    ot = 'index-module__toggle-track__82VKI',
    rt = 'index-module__toggle-slider__tkY4o',
    dt = 'index-module__slide-right__qPOZu',
    ct = 'index-module__toggle-option__ZhXXU',
    _t = 'index-module__active__Mr5KU',
    ut = 'index-module__toggle-icon__AI6K7',
    mt = 'index-module__toggle-label__1qZLz',
    pt = 'index-module__divider__QXSgp',
    ht = 'index-module__action-buttons__xGRHl',
    xt = 'index-module__action-btn__x4IAP',
    gt = 'index-module__btn-icon__ZaYHk',
    vt = 'index-module__btn-label__tM2Rz',
    jt = 'index-module__ai-btn__5kAV3',
    bt = 'index-module__config-incomplete__bLEHk',
    ft = 'index-module__config-badge__0znDE',
    Nt = 'index-module__changelog-section__afcqm',
    yt = 'index-module__filter-section__gMBIz',
    kt = 'index-module__events-section__gJwdk',
    Ct = ({
      appMode: t,
      events: a,
      totalCount: n,
      ...
      return m.jsxs('div', {
        ...
        children: [
          m.jsxs('div', {
            ...
            children: [
              m.jsx('div', {
                ...
                children: m.jsx('div', {
                  ...
                  children: m.jsxs('div', {
                    ...
                    children: [
                      m.jsx('div', {
                        className: `${rt} ${'changelog' === t ? dt : ''}`,
                      }),
                      m.jsxs('button', {
                        className: `${ct} ${'events' === t ? _t : ''}`,
                        onClick: () => d('events'),
                        children: [
                          m.jsx('span', { className: ut, children: '📋' }),
                          m.jsx('span', { className: mt, children: 'Events' }),
                        ],
                      }),
                      m.jsxs('button', {
                        className: `${ct} ${'changelog' === t ? _t : ''}`,
                        onClick: () => d('changelog'),
                        children: [
                          m.jsx('span', { className: ut, children: '📝' }),
                          m.jsx('span', {
              ...
              m.jsxs('div', {
                className: lt,
                children: [
                  m.jsx(tt, { currentVersion: v }),
                  m.jsx('div', { className: pt }),
                  m.jsxs('div', {
                    className: ht,
                    children: [
                      m.jsxs('button', {
                        className: `${xt} ${f.isValid ? '' : bt}`,
                        onClick: g,
                        title: f.isValid
                          ? '设置'
                      ...
                      m.jsxs('button', {
                        ...
                        children: [
                          ...
                          m.jsx('span', { className: vt, children: 'AI 周报' }),
                        ],
                      }),
                    ],
                  }),
          ...
          'events' === t
            ...
            : m.jsx('div', { className: Nt, children: m.jsx(Oe, {}) }),
        ],
      })
    },
    wt = 'index-module__modal-mask__XYxyO',
    Et = 'index-module__modal-wrapper__bVZip',
          ...
          children: m.jsxs('div', {
            ...
            children: [
              m.jsxs('div', {
                className: Tt,
                children: [
                  m.jsx('div', { className: Mt, children: a }),
                  m.jsx('button', {
                    className: $t,
                    onClick: o,
                    children: m.jsx('span', { children: '×' }),
              ...
              m.jsx('div', { className: It, children: l }),
              i && m.jsx('div', { className: Dt, children: i }),
            ],
          }),
        }),
      })
    ...
    Pt = 'index-module__clickable__pZ86X',
    Ot = 'index-module__compact__-QN-s',
    Rt = 'index-module__compact-content__wSrCk',
    Ut = 'index-module__status-icon__7jFiQ',
    Gt = 'index-module__compact-text__7OyGG',
    Ft = 'index-module__expand-button__NusWg',
    Bt = 'index-module__expanded-content__Hih4c',
    qt = 'index-module__config-items__quryV',
    ...
    Jt = 'index-module__progress-container__ofPka',
    Wt = 'index-module__progress-bar__CFedX',
    ea = 'index-module__progress-fill__w-23-',
    ta = 'index-module__complete__L0-gl',
    aa = 'index-module__progress-text__uoYK9',
    na = 'index-module__config-item__m6pYF',
    sa = 'index-module__item-info__BhIr5',
    la = 'index-module__item-status__3ppNU',
    ia = [
        ...
        ? m.jsxs('div', {
            ...
            children: [
              m.jsxs('div', {
                ...
                children: [
                  m.jsx('span', { className: Ut, children: '✅' }),
                  m.jsx('span', { className: Gt, children: '配置已完成' }),
                  n &&
                    m.jsx('button', {
                      className: Ft,
                      onClick: e => {
    ...
    da = 'index-module__settings-panel__UCg3H',
    ca = 'index-module__settings-tabs__vPH-t',
    _a = 'index-module__tab-button__FG9Nc',
    ua = 'index-module__tab-icon__rBe-o',
    ma = 'index-module__active__bsBC1',
    pa = 'index-module__settings-content__TqQPH',
    ha = 'index-module__tab-panel__Q2QUI',
    xa = 'index-module__form-group__zKwiA',
    ga = 'index-module__form-label__pwe7O',
    va = 'index-module__required__2vuyW',
    ja = 'index-module__form-input__jGbRP',
    ba = 'index-module__form-select__jbXdq',
    fa = 'index-module__form-textarea__fAVMw',
    Na = 'index-module__form-hint__F0dFQ',
    ya = 'index-module__version-info__y0NZv',
    ka = 'index-module__version-text__bx0HU',
    Ca = 'index-module__settings-footer__qA44X',
    wa = 'index-module__footer-right__bslDg',
    Ea = 'index-module__btn-primary__ZzzFI',
    ...
    Da = ({ isOpen: t, onClose: a, config: n, onSave: s, theme: l }) => {
      ...
      return m.jsx(At, {
        ...
        children: m.jsxs('div', {
          className: da,
          children: [
            m.jsx(ra, { config: i, showDetails: !0, compact: !0 }),
            m.jsxs('div', {
              className: ca,
              children: [
                m.jsxs('button', {
                  className: `${_a} ${'gitlab' === c ? ma : ''}`,
                  onClick: () => _('gitlab'),
                  children: [
                      ...
                      m.jsxs('div', {
                        ...
                        children: [
                          m.jsxs('label', {
                            ...
                            children: [
                              'GitLab 项目地址 ',
                              m.jsx('span', { className: va, children: '*' }),
                            ],
                          }),
                          m.jsx('input', {
                            type: 'text',
            ...
            m.jsx('div', {
              className: ya,
              children: m.jsxs('span', { className: ka, children: ['v', v] }),
            }),
          ],
        }),
      })
    ...
    La = ({
      ...
      return m.jsx(At, {
        ...
        maskClosable: !i,
        children: m.jsxs('div', {
          className: Aa.aiPanel,
          children: [
            m.jsxs('div', {
              className: Aa.dataOverview,
              children: [
                m.jsx('div', {
                  className: Aa.overviewHeader,
                  children: m.jsx('h4', { children: '📊 数据概览' }),
                }),
                m.jsxs('div', {
                  className: Aa.overviewContent,
                  children: [
                    m.jsxs('div', {
                      className: Aa.overviewItem,
                      children: [
                        m.jsx('span', {
                          className: Aa.overviewLabel,
                          children: '选中事件：',
                        }),
                        m.jsxs('span', {
                          className: Aa.overviewValue,
                          children: [o, ' 条'],
                        }),
                      ],
                    }),
                    ...
                    m.jsxs('div', {
                      ...
                      children: [
                        ...
                        m.jsx('span', {
                          className: `${Aa.overviewValue} ${o > 0 ? Aa.ready : Aa.waiting}`,
            ...
            m.jsxs('div', {
              ...
              children: [
                ...
                m.jsxs('div', {
                  className: `${Aa.promptEditor} ${_ ? Aa.expanded : ''}`,
                  children: [
                    m.jsx('textarea', {
                      className: Aa.promptTextarea,
                      value: d,
                    ...
                    m.jsxs('div', {
                      className: Aa.promptFooter,
                      children: [
                        m.jsxs('span', {
                          className: Aa.charCount,
                          children: [d.length, ' 字符'],
                        }),
                        m.jsx('button', {
                          className: `${Aa.btnPrimary} ${(null == a ? void 0 : a.result) ? Aa.regenerate : ''}`,
                          onClick: () => {
                            l(d)
                          },
                          disabled: i || !d.trim(),
            ...
            i &&
              m.jsxs('div', {
                className: Aa.loadingSection,
                children: [
                  m.jsx('div', { className: Aa.loadingSpinner }),
                  m.jsx('p', {
                    children: 'AI 正在分析事件数据，生成周报中...',
                  }),
                  m.jsx('div', {
                    className: Aa.loadingTips,
                    children: m.jsx('span', {
            ...
            (null == a ? void 0 : a.result) &&
              m.jsxs('div', {
                className: Aa.resultSection,
                children: [
                  m.jsxs('div', {
                    className: Aa.resultHeader,
                    children: [
                      m.jsxs('h3', {
                        className: Aa.resultTitle,
                        children: [
                          m.jsx('span', {
                            className: Aa.titleIcon,
                            children: '✨',
                          }),
                          '生成结果',
                        ],
                      ...
                      m.jsx('div', {
                        className: Aa.resultActions,
                        children: m.jsxs('button', {
                          className: `${Aa.actionBtn} ${p ? Aa.copied : ''}`,
                          onClick: () => {
                            ;(null == a ? void 0 : a.result) &&
                              navigator.clipboard
                                .writeText(a.result)
                  ...
                  m.jsx('div', {
                    className: Aa.resultContent,
                    children: m.jsx('div', {
                      className: Aa.resultText,
                      children: a.result,
                    }),
                  }),
                  m.jsx('div', {
                    className: Aa.resultMeta,
                    children: m.jsxs('div', {
                      className: Aa.metaLeft,
                      children: [
                        m.jsx('div', {
                          className: Aa.metaItem,
            ...
            !a &&
              !i &&
              m.jsxs('div', {
                className: Aa.emptyResult,
                children: [
                  m.jsx('div', { className: Aa.emptyIcon, children: '🤖' }),
                  ...
                  m.jsxs('div', {
                    className: Aa.emptyFeatures,
                    children: [
                      m.jsxs('div', {
                        className: Aa.featureItem,
                        children: [
                          m.jsx('span', {
                            className: Aa.featureIcon,
                            children: '📊',
                          }),
    ...
    Ua = ({ isUserscript: t = !1 }) => {
      const {
        ...
        y = e.useMemo(
          () => Se(a.config.gitlabUrl, a.config.gitlabToken),
            ...
            if (g())
              if (0 !== T.length) {
                ...
                try {
                  ...
                  p({ prompt: e, tokensUsed: l.tokensUsed, result: l.content }),
                    h(!1)
                } catch (t) {
      ...
      return m.jsxs('div', {
        ...
        children: [
          ...
          m.jsx(Oa, { event: k, visible: w, onClose: Z }),
          m.jsx(Da, {
    ...
    Fa = () => {
      ;(window.location.hostname.includes('gitlab') ||
        ...
        ('loading' === document.readyState
          ? document.addEventListener('DOMContentLoaded', Ga)
          : Ga())
    }
  Fa()
  let Ba = location.href,
    qa = new MutationObserver(() => {
      ...
      e !== Ba &&
        ...
        (() => {
          ...
          e && e.remove(),
            t && t.remove(),
            a && a.remove(),
            qa && (qa.disconnect(), (qa = null))
        })(),
        setTimeout(Fa, 1e3))
    })
  qa.observe(document, { subtree: !0, childList: !0 })
  class Va {
    constructor(e) {
