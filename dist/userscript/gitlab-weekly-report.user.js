...
!(function (e, t) {
  ...
  const G = 'index-module__main-panel__82FLm',
    q = 'index-module__panel-header__kyx4p',
    F = 'index-module__header-left__xT1T5',
    B = 'index-module__config-status__CgP3u',
    z = 'index-module__status-indicator__-GO2B',
    K = 'index-module__status-icon__fpfqN',
    J = 'index-module__config-valid__3xaIL',
    Y = 'index-module__config-invalid__-eGA8',
    H = 'index-module__header-right__7F8Bo',
    Q = 'index-module__action-btn__x4IAP',
    V = 'index-module__icon__tX8wX',
    X = 'index-module__settings-btn__vsg3u',
    Z = 'index-module__ai-btn__5kAV3',
    W = 'index-module__filter-section__gMBIz',
    ee = 'index-module__filter-section-content__A3AOe',
    te = 'index-module__filter-group__hk7qq',
    ae = 'index-module__filter-label__TDZ3H',
    se = 'index-module__filter-options__4AUEQ',
    ne = 'index-module__filter-option__-CSf1',
    le = 'index-module__active__Mr5KU',
    ie = 'index-module__events-section__gJwdk',
    oe = [
      { value: 'week', label: '本周' },
      { value: '7d', label: '最近7天' },
    ...
    ce = ({ filterConditions: e, onFilterChange: t }) =>
      m.jsxs('div', {
        className: ee,
        children: [
          m.jsxs('div', {
            className: te,
            children: [
              m.jsx('label', { className: ae, children: '时间范围' }),
              m.jsx('div', {
                className: se,
                children: oe.map(a =>
                  m.jsx(
                    'button',
                    {
                      className: `${ne} ${e.timeRange === a.value ? le : ''}`,
                      onClick: () => {
          ...
          m.jsxs('div', {
            className: te,
            children: [
              m.jsx('label', { className: ae, children: '目标类型' }),
              m.jsxs('div', {
                className: se,
                children: [
                  m.jsx('button', {
                    className: `${ne} ${0 === e.targetType.length ? le : ''}`,
                  ...
                  re.map(a =>
                    m.jsx(
                      'button',
                      {
                        className: `${ne} ${e.targetType.includes(a.value) ? le : ''}`,
                        onClick: () =>
                          ((a, s) => {
                            const n = s
                              ? [...e.targetType, a]
          ...
          m.jsxs('div', {
            className: te,
            children: [
              m.jsx('label', { className: ae, children: '操作类型' }),
              m.jsxs('div', {
                className: se,
                children: [
                  m.jsx('button', {
                    className: `${ne} ${0 === e.action.length ? le : ''}`,
                    onClick: () => t({ ...e, action: [] }),
                    children: '全部',
                  }),
                  de.map(a =>
                    m.jsx(
                      'button',
                      {
                        className: `${ne} ${e.action.includes(a.value) ? le : ''}`,
                        onClick: () =>
                          ((a, s) => {
                            const n = s
                              ? [...e.action, a]
    ...
    _e = 'index-module__pagination__5dauU',
    ue = 'index-module__pagination-info__xbUbw',
    me = 'index-module__pagination-controls__q2hqL',
    pe = 'index-module__pagination-btn__P1OCG',
    he = 'index-module__disabled__BywdX',
    ve = 'index-module__active__lSJu-',
    xe = 'index-module__pagination-ellipsis__gQnax',
    ge = 'index-module__pagination-size-changer__SufyI',
    be = 'index-module__pagination-select__JwvbH',
    je = ({
      current: t,
      pageSize: a,
      total: s,
      ...
      return 0 === s
        ? m.jsx('div', {
            className: _e,
            children: m.jsx('div', { className: ue, children: '暂无数据' }),
          })
        : m.jsxs('div', {
            className: _e,
            children: [
                      ...
                      e.Fragment,
                      {
                        children:
                          'number' == typeof a
                            ...
                            : m.jsx('span', { className: xe, children: a }),
                      },
                      s,
                    ),
                  ),
    ...
    fe = 'EventsList-module__events-list__Z2gnl',
    Ne = 'EventsList-module__events-list-header__i8ZCs',
    ye = 'EventsList-module__header-cell__tSGKU',
    Ee = 'EventsList-module__checkbox-cell__YvmEK',
    ke = 'EventsList-module__content-cell__aiH0X',
    we = 'EventsList-module__action-cell__BBBS7',
    Ce = 'EventsList-module__time-cell__F02or',
    Te = 'EventsList-module__detail-cell__soty-',
    Se = 'EventsList-module__sort-icon__OkgLv',
    De = 'EventsList-module__events-list-body__Pcosk',
    Me = 'EventsList-module__event-row__ka77Q',
    $e = 'EventsList-module__selected__YUioo',
    Ae = 'EventsList-module__cell__5Y8iC',
    Le = 'EventsList-module__event-icon__52LqG',
    Ie = 'EventsList-module__event-content__I8le1',
    Oe = 'EventsList-module__event-title__wVvqr',
    Ue = 'EventsList-module__event-description__GZfW0',
    Re = 'EventsList-module__action-tag__IBpm0',
    Pe = 'EventsList-module__event-time__RCPoO',
    Ge = 'EventsList-module__detail-btn__PLLL4',
    qe = 'EventsList-module__detail-icon__eATZo',
    Fe = 'EventsList-module__empty-state__Z-gwH',
    Be = 'EventsList-module__empty-icon__R7-ij',
    ze = 'EventsList-module__events-list-footer__7LiRc',
    Ke = 'EventsList-module__events-list-loading__pcl-h',
    Je = 'EventsList-module__loading-spinner__rJ-Jy',
    Ye = 'EventsList-module__checkbox-container__L1if8',
    He = 'EventsList-module__checkmark__-GyO9',
    Qe = ({
      events: e,
      totalCount: t,
      loading: a,
            ...
            children: [
              m.jsxs('div', {
                ...
                children: [
                  ...
                  m.jsx('div', { className: `${ye} ${Te}`, children: '详情' }),
                ],
              }),
              m.jsx('div', {
                className: De,
                          ...
                          'div',
                          {
                            ...
                            children: [
                              ...
                              m.jsxs('div', {
                                className: `${Ae} ${ke}`,
                                children: [
                                  m.jsx('div', { className: Le, children: a }),
                                  m.jsxs('div', {
                                    className: Ie,
                                    children: [
                                      m.jsx('div', {
    ...
    Ve = 'index-module__action-btn__To7Ms',
    Xe = 'index-module__checking__QepNt',
    Ze = 'index-module__version-btn__8d3di',
    We = 'index-module__has-update__tNkZZ',
    et = 'index-module__icon__EhhVu',
    tt = 'index-module__text__4iX-h',
    at = 'index-module__notification-overlay__E4dh-',
    st = 'index-module__notification__ckX1l',
    nt = 'index-module__notification-header__nJZ3Q',
    lt = 'index-module__close-btn__9uULv',
    it = 'index-module__notification-body__nnab7',
    ot = 'index-module__version-info__-pyIP',
    rt = 'index-module__release-notes__iU2jG',
    dt = 'index-module__notes-content__ZpxxA',
    ct = 'index-module__notification-footer__La-ia',
    _t = 'index-module__later-btn__Q40Lc',
    ut = 'index-module__update-btn__lD1V2',
    mt = ({ currentVersion: t }) => {
          ...
          children: [
            m.jsxs('button', {
              ...
              title: c
                ...
                : '点击检查更新',
              children: [
                m.jsx('span', { className: et, children: C() }),
                m.jsx('span', { className: tt, children: w() }),
              ],
            }),
            r &&
              i &&
    ...
    pt = ({
      ...
      return m.jsxs('div', {
        ...
        children: [
          m.jsxs('div', {
            ...
            children: [
              m.jsxs('div', {
                className: F,
                children: [
                  m.jsx('h1', { children: 'GitLab Events' }),
                  m.jsx('div', {
                    className: B,
                    children: v()
                      ? m.jsxs('span', {
                          className: `${z} ${J}`,
                          children: [
                            m.jsx('span', { className: K, children: '✅' }),
                            '配置完整',
                          ],
                        })
                      : m.jsxs('span', {
              ...
              m.jsxs('div', {
                className: H,
                children: [
                  m.jsx(mt, { currentVersion: j }),
                  m.jsxs('button', {
                    className: `${Q} ${X}`,
                    onClick: p,
                    children: [
                      m.jsx('span', { className: V, children: '⚙️' }),
                      '设置',
                    ],
                  }),
                  m.jsxs('button', {
                    ...
                    onClick: h,
                    children: [
                      m.jsx('span', { className: V, children: '🤖' }),
                      'AI 周报',
                    ],
                  }),
                ],
          ...
          m.jsx('div', {
            className: W,
            children: m.jsx(ce, { filterConditions: s, onFilterChange: o }),
          }),
          m.jsx('div', {
            className: ie,
            children: m.jsx(Qe, {
    ...
    ht = 'index-module__modal-mask__XYxyO',
    vt = 'index-module__modal-wrapper__bVZip',
    xt = 'index-module__modal__QQS3u',
    gt = 'index-module__modal-header__GdUjX',
    bt = 'index-module__modal-title__cafB-',
    jt = 'index-module__modal-close__ZuUgf',
    ft = 'index-module__modal-body__j5X3U',
        ...
        children: m.jsx('div', {
          ...
          children: m.jsxs('div', {
            ...
            children: [
              ...
              m.jsx('div', { className: ft, children: l }),
              i && m.jsx('div', { className: Nt, children: i }),
            ],
          }),
        }),
      })
    ...
    kt = 'index-module__settings-tabs__vPH-t',
    wt = 'index-module__tab-button__FG9Nc',
    Ct = 'index-module__tab-icon__rBe-o',
    Tt = 'index-module__active__bsBC1',
    St = 'index-module__settings-content__TqQPH',
    Dt = 'index-module__tab-panel__Q2QUI',
    Mt = 'index-module__form-group__zKwiA',
    $t = 'index-module__form-label__pwe7O',
    At = 'index-module__required__2vuyW',
    Lt = 'index-module__form-input__jGbRP',
    It = 'index-module__form-select__jbXdq',
    Ot = 'index-module__form-textarea__fAVMw',
    Ut = 'index-module__form-hint__F0dFQ',
    Rt = 'index-module__version-info__y0NZv',
    Pt = 'index-module__version-text__bx0HU',
    Gt = 'index-module__settings-footer__qA44X',
    qt = 'index-module__footer-right__bslDg',
    Ft = 'index-module__btn-primary__ZzzFI',
    Bt = 'index-module__switch-container__5xk1J',
    zt = 'index-module__switch-input__V-8fl',
    Kt = 'index-module__switch-label__xrOeQ',
    Jt = 'index-module__switch-slider__dG-6J',
    Yt = 'index-module__btn-secondary__cRCpD',
    Ht = ({ isOpen: t, onClose: a, config: s, onSave: n, theme: l }) => {
      ...
      return m.jsx(yt, {
        ...
        children: m.jsxs('div', {
          ...
          children: [
                      ...
                      m.jsxs('div', {
                        ...
                        children: [
                          m.jsxs('label', {
                            ...
                            children: [
                              'GitLab 项目地址 ',
                              m.jsx('span', { className: At, children: '*' }),
                            ],
                          }),
                          m.jsx('input', {
                            type: 'text',
                          ...
                          m.jsxs('div', {
                            ...
                            children: [
                              ...
                              m.jsx('label', {
                                ...
                                className: Kt,
                                children: m.jsx('span', { className: Jt }),
                              }),
                            ],
                          }),
                          m.jsx('div', {
            ...
            m.jsx('div', {
              className: Rt,
              children: m.jsxs('span', { className: Pt, children: ['v', j] }),
            }),
          ],
        }),
      })
    },
    Qt = 'index-module__ai-panel__R0K19',
    Vt = 'index-module__data-overview__J-ZoM',
    Xt = 'index-module__overview-header__ae0e8',
    Zt = 'index-module__overview-content__dhjh6',
    Wt = 'index-module__overview-item__20Ilu',
    ea = 'index-module__overview-label__k3QHX',
    ta = 'index-module__overview-value__gbEnJ',
    aa = 'index-module__ready__f4MXX',
    sa = 'index-module__waiting__orgl9',
    na = 'index-module__result-section__esrDe',
    la = 'index-module__result-header__-sHRM',
    ia = 'index-module__result-title__GYp3Q',
    oa = 'index-module__title-icon__w1Z58',
    ra = 'index-module__result-actions__Lwz6b',
    da = 'index-module__action-btn__X81KS',
    ca = 'index-module__btn-icon__bBkUh',
    _a = 'index-module__result-content__NBmXz',
    ua = 'index-module__result-text__WX-aI',
    ma = 'index-module__result-meta__zAR0J',
    pa = 'index-module__meta-left__G7E6i',
    ha = 'index-module__meta-item__Mikx5',
    va = 'index-module__prompt-section__Y1L-1',
    xa = 'index-module__section-header__WEXG-',
    ga = 'index-module__header-actions__phC5-',
    ba = 'index-module__prompt-editor__N6csy',
    ja = 'index-module__prompt-textarea__ZeYSC',
    fa = 'index-module__prompt-footer__NhJb8',
    Na = 'index-module__char-count__qSePr',
    ya = 'index-module__expanded__VY5Zd',
    Ea = 'index-module__loading-section__qmhp-',
    ka = 'index-module__loading-spinner__FhbKe',
    wa = 'index-module__loading-tips__TN0F6',
    Ca = 'index-module__empty-result__D1DxK',
    Ta = 'index-module__empty-icon__RFmRa',
    Sa = 'index-module__empty-features__Y-XeR',
    Da = 'index-module__feature-item__zmC1K',
    Ma = 'index-module__feature-icon__aCith',
    $a = 'index-module__btn-primary__NTwQw',
    Aa = 'index-module__regenerate__MPpEF',
    La = 'index-module__btn-text__f3PZM',
    Ia = ({
      visible: t,
      config: a,
      defaultPrompt: s,
          ...
          children: [
                  ...
                  children: [
                    m.jsxs('div', {
                      ...
                      children: [
                        ...
                        m.jsxs('span', { className: ta, children: [o, ' 条'] }),
                      ],
                    }),
                    r &&
                      m.jsxs('div', {
                    ...
                    m.jsxs('div', {
                      className: Wt,
                      children: [
                        m.jsx('span', { className: ea, children: '状态：' }),
                        m.jsx('span', {
                          className: `${ta} ${o > 0 ? aa : sa}`,
                  ...
                  children: [
                    ...
                    m.jsxs('div', {
                      ...
                      children: [
                        ...
                        m.jsx('button', {
                          className: `${$a} ${(null == a ? void 0 : a.result) ? Aa : ''}`,
                          onClick: () => {
                            l(d)
                          },
                          disabled: i || !d.trim(),
                  ...
                  m.jsxs('div', {
                    ...
                    children: [
                      m.jsxs('h3', {
                        className: ia,
                        children: [
                          m.jsx('span', { className: oa, children: '✨' }),
                          '生成结果',
                        ],
                      }),
                      m.jsx('div', {
                        ...
                        children: m.jsxs('button', {
                          ...
                          title: '一键复制',
                          children: [
                            m.jsx('span', { className: ca, children: '📋' }),
                            '复制',
                          ],
                        }),
                      }),
            ...
            !a &&
              ...
              m.jsxs('div', {
                className: Ca,
                children: [
                  m.jsx('div', { className: Ta, children: '🤖' }),
                  ...
                  m.jsxs('div', {
                    ...
                    children: [
                      m.jsxs('div', {
                        className: Da,
                        children: [
                          m.jsx('span', { className: Ma, children: '📊' }),
    ...
    Ua = ({ event: e, visible: t, onClose: a }) => {
      ...
      return m.jsx('div', {
        className: Oa.eventDetailModalOverlay,
        onClick: a,
        children: m.jsxs('div', {
          className: Oa.eventDetailModal,
          onClick: e => e.stopPropagation(),
          children: [
            m.jsxs('div', {
              className: Oa.modalHeader,
              children: [
            ...
            m.jsxs('div', {
              className: Oa.modalContent,
              children: [
                m.jsxs('div', {
                  className: `${Oa.detailSection} ${Oa.compact}`,
                  children: [
                    m.jsx('h3', { children: '基本信息' }),
                    m.jsxs('div', {
                      className: `${Oa.detailGrid} ${Oa.compactGrid}`,
                      children: [
                        m.jsxs('div', {
                          className: Oa.detailItem,
                          children: [
                            m.jsx('span', {
                              className: Oa.label,
                              children: 'ID:',
                        ...
                        m.jsxs('div', {
                          ...
                          children: [
                            ...
                            m.jsx('span', {
                              className: `${Oa.value} ${Oa.actionBadge}`,
                              children:
                                ((l = e.action_name),
                                {
                                  opened: '开启',
                        ...
                        e.state &&
                          m.jsxs('div', {
                            ...
                            children: [
                              ...
                              m.jsx('span', {
                                className: `${Oa.value} ${Oa.statusBadge} ${Oa[`status-${e.state}`]}`,
                                children: e.state,
                              }),
                            ],
                          }),
                ...
                (e.title ||
                  ...
                  m.jsxs('div', {
                    ...
                    children: [
                      ...
                      m.jsxs('div', {
                        className: `${Oa.detailContent} ${Oa.compactContent}`,
                        children: [
                          e.title &&
                            m.jsxs('div', {
                              className: Oa.detailItem,
                              ...
                              children: [
                                ...
                                m.jsx('div', {
                                  ...
                                  children: e.labels.map((e, t) =>
                                    m.jsx(
                                      'span',
                                      { className: Oa.labelTag, children: e },
                                      t,
                                    ),
                                  ),
                                }),
                ...
                e.author &&
                  m.jsxs('div', {
                    ...
                    children: [
                      ...
                      m.jsxs('div', {
                        className: `${Oa.authorInfo} ${Oa.compactAuthor}`,
                        children: [
                          e.author.avatar_url &&
                            m.jsx('img', {
                              src: `${e.author.avatar_url}?width=100`,
                              alt: e.author.name,
                              className: Oa.authorAvatar,
                            }),
                          m.jsxs('div', {
                            className: Oa.authorDetails,
                            children: [
                              m.jsx('div', {
                                className: Oa.authorName,
                                children: e.author.name,
                              }),
                              m.jsxs('div', {
                                className: Oa.authorUsername,
                ...
                (e.project || e.project_id) &&
                  m.jsxs('div', {
                    ...
                    children: [
                      ...
                      m.jsx('div', {
                        className: `${Oa.projectInfo} ${Oa.compactProject}`,
                        children: e.project
                          ? m.jsxs(m.Fragment, {
                              children: [
                                m.jsxs('div', {
                ...
                e.push_data &&
                  m.jsxs('div', {
                    className: Oa.detailSection,
                    children: [
                      m.jsx('h3', { children: '推送信息' }),
                      m.jsxs('div', {
                        className: Oa.pushInfo,
                        children: [
                          m.jsxs('div', {
                            className: Oa.detailItem,
                            children: [
                          ...
                          m.jsxs('div', {
                            ...
                            children: [
                              ...
                              m.jsx('span', {
                                className: `${Oa.value} ${Oa.commitHash}`,
                ...
                e.note &&
                  m.jsxs('div', {
                    ...
                    children: [
                      ...
                      m.jsxs('div', {
                        className: Oa.noteInfo,
                        children: [
                          m.jsx('div', {
                            className: Oa.noteBody,
                            children: e.note.body,
                          }),
                          m.jsxs('div', {
                            className: Oa.noteMeta,
                            children: [
                              m.jsxs('span', {
              ...
              children: [
                n() &&
                  m.jsx('a', {
                    ...
                    className: Oa.sourceLinkBtn,
                    children: '打开源页面',
                  }),
                m.jsx('button', {
                  className: Oa.closeModalBtn,
                  onClick: a,
                  children: '关闭',
                }),
              ],
  ...
  class Ra {
    ...
    async request(e, t = {}) {
      ...
      if (!n.ok) {
        ...
        throw D.createApiError(n.status, t, 'GitLab API')
      }
      return n.json()
    }
    /**
     ...
     */ async getCurrentUser() {
      ...
      if (!this.validateToken())
        throw D.createResponseError('Token格式无效', 'GitLab API')
     ...
     */ async getUserEventsWithTotal(e, t = {}) {
      ...
      if (!o.ok) {
        ...
        throw D.createApiError(o.status, e || o.statusText, 'GitLab API')
      }
  ...
  const Pa = {
    ...
    Ga = ({ isUserscript: t = !1 }) => {
      const {
        ...
        f = e.useMemo(() => {
          return (
            (e = a.config.gitlabUrl), (t = a.config.gitlabToken), new Ra(e, t)
          )
          var e, t
            ...
            const { startDate: l, endDate: i } = v(),
              ...
              _ =
                (null == (s = o.action) ? void 0 : s.length) > 0
                  ? o.action
                  : void 0,
              u = a.sortOptions.order || 'desc',
              m = await f.getCurrentUser(),
              p = {
                after: l,
                before: i,
                target_type: r,
              ...
              { events: h, total: x } = await f.getUserEventsWithTotal(m.id, p)
            if (g(n)) return
            d(h), C(h.map(e => e.id)), c(x)
          } catch (l) {
            if (j(l)) return
            const e = D.formatErrorMessage(l)
            p(e), d([]), c(0)
          } finally {
            g(n) || u(!1), b(n)
          }
      ...
      return m.jsxs('div', {
        ...
        className: `${Pa.app} ${t ? Pa.userscriptMode : Pa.webMode} ${Pa[T]}`,
        children: [
          m.jsx(pt, {
            events: a.events,
              ...
              if (h())
                if (0 !== w.length) {
                  ...
                  try {
                    ...
                    const e = D.formatErrorMessage(t)
                    p(e), u(!1)
                  }
                } else p(O)
              else p(I)
    ...
    qa = () => {
      ...
      a.createRoot(s).render(e.createElement(Ga, { isUserscript: !0 }))
    },
    Fa = () => {
  ...
  class za {
     ...
     */ async generateChat(e, t = 'deepseek-chat', a = 4e3) {
      ...
      if (!s.ok) throw D.createApiError(s.status, s.statusText, 'DeepSeek API')
      const n = await s.json()
      if (!n.choices || 0 === n.choices.length)
        throw D.createResponseError('空的响应', 'DeepSeek API')
     ...
     */ async generateWeeklyReport(e, t, a = 'deepseek-chat', s = 4e3) {
      ...
      if (!i.ok) throw D.createApiError(i.status, i.statusText, 'DeepSeek API')
