...
!(function (e, t) {
  ...
  const Ie = ({
                ...
                try {
                  ...
                  const _ = await d.json(),
                    m = {
                      ...
                      releaseNotes: `版本 ${_.version} 已发布，请及时更新以获得最新功能和修复。`,
                    }
                  s(m), u(new Date()), v(!0)
          ...
          children: [
            m.jsxs('button', {
              ...
              title: _
                ...
                : '点击检查更新',
              children: [
                m.jsx('span', { className: Be, children: S() }),
    ...
    bt = 'index-module__ai-btn__5kAV3',
    jt = 'index-module__config-incomplete__bLEHk',
    ...
    ba = 'index-module__form-input__jGbRP',
    ja = 'index-module__form-select__jbXdq',
