            ...
            <div className="pro-table-header">
                ...
                <div className="header-right">
                    <div className="header-actions">
                        <button id="openSettings" onClick={onOpenSettings} className="action-btn settings" title="打开设置">
            ...
            <div className="pro-table-query">
                <div className="query-form">
                    <div className="form-row">
                        ...
                        {/* 操作按钮 */}
                        <div className="form-item action-buttons-item">
                            <label className="form-label">操作</label>
                            <div className="action-buttons">
                                <button id="refreshEvents" onClick={onRefreshEvents} className="action-btn-text refresh" title="刷新数据">
                                    刷新数据
                                </button>
                                <button id="clearFilters" onClick={onClearFilters} className="action-btn-text clear" title="清除筛选">
                                    清空筛选
                                </button>
                            </div>
                        </div>
